...
seo:
  title: Tag types
  description: >-
    Categorize and analyze emails with EagleEye's smart tagging system—supporting rules-based tags, AI tags, and AI with Mentions for extracting names.
