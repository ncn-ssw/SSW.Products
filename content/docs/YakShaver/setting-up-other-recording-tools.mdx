...
If you want to be a power user and speak to YakShaver just by pressing the "Print Screen" button on your keyboard, use a recording tool with advanced features such as Snagit rather than MS Teams.
...
1. ⚠️ IMPORTANT: YakShaver | Type **OFF** in the YakShaver Teams bot. This is to prevent processing your old videos
...
![](/snagit-tutorial.jpg)**Figure: Example of Snagit saving directory**
